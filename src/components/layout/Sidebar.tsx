import { LayoutDashboard, FlaskConical, FileText, Settings, Bell, ChevronLeft, Cpu, Brain, Database, Zap } from 'lucide-react';
import { useApp } from '../../context/AppContext';
import { Page } from '../../types';

const NAV_ITEMS: { page: Page; icon: React.ElementType; label: string; badge?: string }[] = [
  { page: 'dashboard', icon: LayoutDashboard, label: 'Dashboard' },
  { page: 'lab-command-center', icon: Zap, label: 'Lab Command Center' },
